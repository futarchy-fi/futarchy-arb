...
// =============================================================================
// PERMISSIONLESS FLASH ARBITRAGE CONTRACT (V4)
// =============================================================================

/**
 * @title GnosisFlashArbitrageV4
 * @notice PERMISSIONLESS flash loan arbitrage using Balancer V3 Vault on Gnosis Chain
 * @dev Removes onlyOwner - anyone can execute arbitrage, profits go to msg.sender
 * 
 * Key differences from V3:
 * - No Ownable inheritance - fully permissionless
 * - Anyone can call executeArbitrage()
 * - Profits always sent to the caller (msg.sender)
 * - Admin address for emergency token recovery only
 */
